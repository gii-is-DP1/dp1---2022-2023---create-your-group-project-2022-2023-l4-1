...
<game:layout pageName="home">
    <c:choose>
        <c:when test="${partida.getFaseActual()==fin}">
            <c:redirect url="/partida/tablero/fin/${partida.id}"/>
        </c:when>
        <c:otherwise>
                ...
                <div class="board">
                    <div class="celda">
                        <c:choose>
                            ...
                            <c:when test="${partida.getEspecialActivada()!=desactivada && (tablero.getCeldas().get(0).getCartas().size()>1 || partida.getEspecialActivada()==especial7) && actual==partida.getJugadorActivo() && partida.getFaseActual()==fase2}">
                                <spring:url value="/partida/tablero/celda1/${partida.id}" var="editUrl"></spring:url>
                                    <a href="${fn:escapeXml(editUrl)}" class="btn btn-default">
                                        <img id= "celda0" width="190" height="266" src="${tablero.getCeldas().get(0).getCartas().get(0).getImagen()}">
                                    </a>
                            </c:when>
                            <c:when test="${tablero.getCeldas().get(0).getOcupado()==false && partida.getFaseActual()==fase3 && jugador_actual.getNumEnanosPico()!=0 && actual==partida.getJugadorActivo()}">
                                <spring:url value="/partida/tablero/celda1/${partida.id}" var="editUrl"></spring:url>
                                    <a href="${fn:escapeXml(editUrl)}" class="btn btn-default">
                                        <img id= "celda0" width="190" height="266" src="${tablero.getCeldas().get(0).getCartas().get(0).getImagen()}">
                                    </a>
                            ...
                            <c:otherwise>
                                ...
                                <c:if test="${tablero.getCeldas().get(0).getOcupado()==true && partida.getFaseActual()!=fase1}">
                    ...
                    <div class="celda">
                        <c:choose>
                            ...
                            <c:when test="${partida.getEspecialActivada()!=desactivada && (tablero.getCeldas().get(1).getCartas().size()>1 || partida.getEspecialActivada()==especial7) && actual==partida.getJugadorActivo() && partida.getFaseActual()==fase2}">
                                <spring:url value="/partida/tablero/celda2/${partida.id}" var="editUrl"></spring:url>
                                    <a href="${fn:escapeXml(editUrl)}" class="btn btn-default">
                                        <img id= "celda1" width="190" height="266" src="${tablero.getCeldas().get(1).getCartas().get(0).getImagen()}">
                                    </a>
                            </c:when>
                            <c:when test="${tablero.getCeldas().get(1).getOcupado()==false && partida.getFaseActual()==fase3 && jugador_actual.getNumEnanosPico()!=0 && actual==partida.getJugadorActivo()}">
                                <spring:url value="/partida/tablero/celda2/${partida.id}" var="editUrl"></spring:url>
                                    <a href="${fn:escapeXml(editUrl)}" class="btn btn-default">
                                        <img id= "celda1" width="190" height="266" src="${tablero.getCeldas().get(1).getCartas().get(0).getImagen()}">
                                    </a>
                            ...
                            <c:otherwise>
                                ...
                                <c:if test="${tablero.getCeldas().get(1).getOcupado()==true && partida.getFaseActual()!=fase1}">
                    ...
                    <div class="celda">
                        <c:choose>
                            ...
                            <c:when test="${partida.getEspecialActivada()!=desactivada && (tablero.getCeldas().get(2).getCartas().size()>1 || partida.getEspecialActivada()==especial7) && actual==partida.getJugadorActivo() && partida.getFaseActual()==fase2}">
                                <spring:url value="/partida/tablero/celda3/${partida.id}" var="editUrl"></spring:url>
                                    <a href="${fn:escapeXml(editUrl)}" class="btn btn-default">
                                        <img id= "celda2" width="190" height="266" src="${tablero.getCeldas().get(2).getCartas().get(0).getImagen()}">
                                    </a>
                            </c:when>
                            <c:when test="${tablero.getCeldas().get(2).getOcupado()==false && partida.getFaseActual()==fase3 && jugador_actual.getNumEnanosPico()!=0 && actual==partida.getJugadorActivo()}">
                                <spring:url value="/partida/tablero/celda3/${partida.id}" var="editUrl"></spring:url>
                                    <a href="${fn:escapeXml(editUrl)}" class="btn btn-default">
                                        <img id= "celda2" width="190" height="266" src="${tablero.getCeldas().get(3).getCartas().get(0).getImagen()}">
                                    </a>
                            </c:when>
                            <c:otherwise>
                                <img id= "celda2" width="202" height="282" src="${tablero.getCeldas().get(2).getCartas().get(0).getImagen()}">
                                <c:if test="${tablero.getCeldas().get(2).getOcupado()==true && partida.getFaseActual()!=fase1}">
                    ...
                    <div class="celda">
                        <c:choose>
                            ...
                            <c:when test="${partida.getEspecialActivada()!=desactivada && (tablero.getCeldas().get(3).getCartas().size()>1 || partida.getEspecialActivada()==especial7) && actual==partida.getJugadorActivo() && partida.getFaseActual()==fase2}">
                                <spring:url value="/partida/tablero/celda4/${partida.id}" var="editUrl"></spring:url>
                                    <a href="${fn:escapeXml(editUrl)}" class="btn btn-default">
                                        <img id= "celda3" width="190" height="266" src="${tablero.getCeldas().get(3).getCartas().get(0).getImagen()}">
                                    </a>
                            </c:when>
                            <c:when test="${tablero.getCeldas().get(3).getOcupado()==false && partida.getFaseActual()==fase3 && jugador_actual.getNumEnanosPico()!=0 && actual==partida.getJugadorActivo()}">
                                <spring:url value="/partida/tablero/celda4/${partida.id}" var="editUrl"></spring:url>
                                    <a href="${fn:escapeXml(editUrl)}" class="btn btn-default">
                                        <img id= "celda3" width="190" height="266" src="${tablero.getCeldas().get(3).getCartas().get(0).getImagen()}">
                                    </a>
                            ...
                            <c:otherwise>
                                ...
                                <c:if test="${tablero.getCeldas().get(3).getOcupado()==true && partida.getFaseActual()!=fase1}">
                    ...
                    <div class="celda">
                        <c:choose>
                            ...
                            <c:when test="${partida.getEspecialActivada()!=desactivada && (tablero.getCeldas().get(4).getCartas().size()>1 || partida.getEspecialActivada()==especial7) && actual==partida.getJugadorActivo() && partida.getFaseActual()==fase2}">
                                <spring:url value="/partida/tablero/celda5/${partida.id}" var="editUrl"></spring:url>
                                    <a href="${fn:escapeXml(editUrl)}" class="btn btn-default">
                                        <img id= "celda4" width="190" height="266" src="${tablero.getCeldas().get(4).getCartas().get(0).getImagen()}">
                                    </a>
                            </c:when>
                            <c:when test="${tablero.getCeldas().get(4).getOcupado()==false && partida.getFaseActual()==fase3 && jugador_actual.getNumEnanosPico()!=0 && actual==partida.getJugadorActivo()}">
                                <spring:url value="/partida/tablero/celda5/${partida.id}" var="editUrl"></spring:url>
                                    <a href="${fn:escapeXml(editUrl)}" class="btn btn-default">
                                        <img id= "celda4" width="190" height="266" src="${tablero.getCeldas().get(4).getCartas().get(0).getImagen()}">
                                    </a>
                            ...
                            <c:otherwise>
                                ...
                                <c:if test="${tablero.getCeldas().get(4).getOcupado()==true && partida.getFaseActual()!=fase1}">
                    ...
                    <div class="celda">
                        <c:choose>
                            ...
                            <c:when test="${partida.getEspecialActivada()!=desactivada && (tablero.getCeldas().get(5).getCartas().size()>1 || partida.getEspecialActivada()==especial7) && actual==partida.getJugadorActivo() && partida.getFaseActual()==fase2}">
                                <spring:url value="/partida/tablero/celda6/${partida.id}" var="editUrl"></spring:url>
                                    <a href="${fn:escapeXml(editUrl)}" class="btn btn-default">
                                        <img id= "celda5" width="190" height="266" src="${tablero.getCeldas().get(5).getCartas().get(0).getImagen()}">
                                    </a>
                            </c:when>
                            <c:when test="${tablero.getCeldas().get(5).getOcupado()==false && partida.getFaseActual()==fase3 && jugador_actual.getNumEnanosPico()!=0 && actual==partida.getJugadorActivo()}">
                                <spring:url value="/partida/tablero/celda6/${partida.id}" var="editUrl"></spring:url>
                                    <a href="${fn:escapeXml(editUrl)}" class="btn btn-default">
                                        <img id= "celda5" width="190" height="266" src="${tablero.getCeldas().get(5).getCartas().get(0).getImagen()}">
                                    </a>
                            ...
                            <c:otherwise>
                                ...
                                <c:if test="${tablero.getCeldas().get(5).getOcupado()==true && partida.getFaseActual()!=fase1}">
                    ...
                    <div class="celda">
                        <c:choose>
                            ...
                            <c:when test="${partida.getEspecialActivada()!=desactivada && (tablero.getCeldas().get(6).getCartas().size()>1 || partida.getEspecialActivada()==especial7) && actual==partida.getJugadorActivo() && partida.getFaseActual()==fase2}">
                                <spring:url value="/partida/tablero/celda7/${partida.id}" var="editUrl"></spring:url>
                                    <a href="${fn:escapeXml(editUrl)}" class="btn btn-default">
                                        <img id= "celda6" width="190" height="266" src="${tablero.getCeldas().get(6).getCartas().get(0).getImagen()}">
                                    </a>
                            </c:when>
                            <c:when test="${tablero.getCeldas().get(6).getOcupado()==false && partida.getFaseActual()==fase3 && jugador_actual.getNumEnanosPico()!=0 && actual==partida.getJugadorActivo()}">
                                <spring:url value="/partida/tablero/celda7/${partida.id}" var="editUrl"></spring:url>
                                    <a href="${fn:escapeXml(editUrl)}" class="btn btn-default">
                                        <img id= "celda6" width="190" height="266" src="${tablero.getCeldas().get(6).getCartas().get(0).getImagen()}">
                                    </a>
                            ...
                            <c:otherwise>
                                ...
                                <c:if test="${tablero.getCeldas().get(6).getOcupado()==true && partida.getFaseActual()!=fase1}">
                    ...
                    <div class="celda">
                        <c:choose>
                            ...
                            <c:when test="${partida.getEspecialActivada()!=desactivada && (tablero.getCeldas().get(7).getCartas().size()>1 || partida.getEspecialActivada()==especial7) && actual==partida.getJugadorActivo() && partida.getFaseActual()==fase2}">
                                <spring:url value="/partida/tablero/celda8/${partida.id}" var="editUrl"></spring:url>
                                    <a href="${fn:escapeXml(editUrl)}" class="btn btn-default">
                                        <img id= "celda7" width="190" height="266" src="${tablero.getCeldas().get(7).getCartas().get(0).getImagen()}">
                                    </a>
                            </c:when>
                            <c:when test="${tablero.getCeldas().get(7).getOcupado()==false && partida.getFaseActual()==fase3 && jugador_actual.getNumEnanosPico()!=0 && actual==partida.getJugadorActivo()}">
                                <spring:url value="/partida/tablero/celda8/${partida.id}" var="editUrl"></spring:url>
                                    <a href="${fn:escapeXml(editUrl)}" class="btn btn-default">
                                        <img id= "celda7" width="190" height="266" src="${tablero.getCeldas().get(7).getCartas().get(0).getImagen()}">
                                    </a>
                            ...
                            <c:otherwise>
                                ...
                                <c:if test="${tablero.getCeldas().get(7).getOcupado()==true && partida.getFaseActual()!=fase1}">
                    ...
                    <div class="celda">
                        <c:choose>
                            ...
                            <c:when test="${partida.getEspecialActivada()!=desactivada && (tablero.getCeldas().get(8).getCartas().size()>1 || partida.getEspecialActivada()==especial7) && actual==partida.getJugadorActivo() && partida.getFaseActual()==fase2}">
                                <spring:url value="/partida/tablero/celda9/${partida.id}" var="editUrl"></spring:url>
                                    <a href="${fn:escapeXml(editUrl)}" class="btn btn-default">
                                        <img id= "celda8" width="190" height="266" src="${tablero.getCeldas().get(8).getCartas().get(0).getImagen()}">
                                    </a>
                            </c:when>
                            <c:when test="${tablero.getCeldas().get(8).getOcupado()==false && partida.getFaseActual()==fase3 && jugador_actual.getNumEnanosPico()!=0 && actual==partida.getJugadorActivo()}">
                                <spring:url value="/partida/tablero/celda9/${partida.id}" var="editUrl"></spring:url>
                                    <a href="${fn:escapeXml(editUrl)}" class="btn btn-default">
                                        <img id= "celda8" width="190" height="266" src="${tablero.getCeldas().get(8).getCartas().get(0).getImagen()}">
                                    </a>
                            ...
                            <c:otherwise>
                                ...
                                <c:if test="${tablero.getCeldas().get(8).getOcupado()==true && partida.getFaseActual()!=fase1}">
                    ...
                    <div class="celda">
                        <c:choose>
                            <c:when test="${actual==partida.getJugadorActivo() && (jugador_actual.getNumEnanosMazo()==2 || (jugador_actual.getNumEnanosMazo()==1 && jugador_actual.getCantidadMedallas()>=4)) && partida.getFaseActual()==fase2 && partida.getEspecialActivada()==desactivada && !(tablero.getCeldasEspeciales().get(0).getCartas().get(0).getPosicion()==3 && jugador_actual.getObjetos().size()>0)}">
