...
INSERT INTO jugadores(username, es_administrador, es_espectador, es_jugador_inicial, es_ganador) VALUES ('pabmarval', 'False', 'False', 'True', 'True');
INSERT INTO jugadores(username, es_administrador, es_espectador, es_jugador_inicial, es_ganador) VALUES ('ignwarmur', 'False', 'False', 'True', 'True');
INSERT INTO jugadores(username, es_administrador, es_espectador, es_jugador_inicial, es_ganador) VALUES ('davcorrom', 'False', 'False', 'True', 'True');

-- partidas ejemplo

INSERT INTO partidas(id, nombre_sala, duracion, ronda, tiempo_restante_ronda, jugador_activo, siguiente_jugador, ganador) VALUES (1, 'prueba', 20, 3, 2, 1, 2, 1);
INSERT INTO partidas(id, nombre_sala, duracion, ronda, tiempo_restante_ronda, jugador_activo, siguiente_jugador, ganador) VALUES (2, 'prueba2', 20, 3, 2, 1, 2, 1);