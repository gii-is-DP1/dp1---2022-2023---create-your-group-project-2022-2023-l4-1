...
public class ChatController {
    ...
    public ModelAndView creaChat(@PathVariable("id") Integer id){
    ...
    public ModelAndView nuevoMensaje(@PathVariable("id") Integer id, @Valid Mensaje mensaje, BindingResult br, Principal principal){
