...
public class invitacionController {
    ...
    @Autowired
	private invitacionService invitationService;
	...
	public String getInvitationes(@PathVariable("username") String username, Model model) {
		List<invitacion> invitaciones = invitationService.getInvitationsOf(username);
		model.addAttribute("invitationsList", invitaciones);
